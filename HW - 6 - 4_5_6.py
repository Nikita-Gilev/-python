...
class warehouse:  # это будет склад и подразделение
...
if __name__ == '__main__':
    ...
    d1 = warehouse('Север', 6, 200)
    d2 = warehouse('Юг', 20, 2000)
